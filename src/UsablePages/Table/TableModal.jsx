  ...
  return (
    <>
      <button
        ...
        className="rounded-sm  btn_table flex items-center gap-1 font-bold duration-500"
      >
                ...
                <Dialog.Panel className="w-[96%] md:w-[90%] lg:w-[75%]  xl:w-[910px] max-w-md:w-[60%] transform overflow-hidden rounded-2xl bg-white dark:bg-[#25293C] text-left align-middle shadow-xl transition-all my-10">
                  ...
                  >
                    <div className="flex  items-center justify-between">
                      <h5 className=" font-light dark:text-white text-xl pt-2 ">
                        New Expense Category
                      </h5>
                      <button
                        onClick={() => setIsOpen(false)}
                        className="close-button dark:text-white pr-6 font-light"
                      >
                        X
                      </button>
                    </div>
                  ...
                  <div className=" dark:border-black bg-[#21252908] text-center">
                    <p className="w-[95%] md:w-[95%] mx-auto  py-2 text-xl md:text-xl leading-6 text-gray-900 dark:text-white ">
                      এক্সপেন্স ক্যাটাগরি একবার তৈরী হয়ে গেলে Delete করা সম্ভব
                      না , প্রয়োজনে edit বা inactive করতে পারবেন। তাই অপ্রয়োজনীয়
                      এক্সপেন্স ক্যাটাগরি তৈরী থেকে বিরত থাকুন।
                    </p>
                  </div>
                  <hr className="mt-4" />
                  <div className="flex flex-col md:flex-row justify-between px-6 w-full">
                    <div className="w-[100%]">
                      {/* Expense Category */}
                      <div className=" mt-6 ">
                        <h6 className="text-lg text-gray-900 dark:text-white pb-0">
                          Category Name
